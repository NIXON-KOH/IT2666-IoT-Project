    ...
    public partial class Bin : Form
    {
        ...
        private void LoadData()
        {
            try
            {
                ...
                {
                    conn.Open();
                    string query = "SELECT Bin_Id, Location, LastCleaned FROM [Bin]";
        ...
        {
            AddBin addbin = new admin.AddBin();
            addbin.Show();
        }
        ...
        {
            UpdateDeleteBin updatedeletebin = new admin.UpdateDeleteBin();
            updatedeletebin.Show();
        }
    }
}
